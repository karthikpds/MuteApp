 ...
 * for mute, keybd_event VK_MEDIA_* for transport).
 ...
 *
 * pause/resume/playpause send system media keys to the current Windows
 * media (SMTC) session — e.g. YouTube Music in Chrome/Edge or a desktop
 * player. WASAPI exposes no per-app transport, so unlike mute these are
 * system-wide, not per-PID.
 *
